...
import { Compass, Mail, Lock, LogIn, Sparkles } from "lucide-react";
        ...
        <Card className="border border-sand-300 rounded-3xl overflow-hidden shadow-lg bg-white">
          <CardContent className="p-8 sm:p-10 space-y-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <h2 className="text-2xl font-black text-deep-navy-950">Welcome back</h2>
              <p className="text-xs text-deep-navy-500">Sign in to sync your saved trips and travel collections.</p>
            </div>
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4 text-left">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-[10px] font-bold text-brand-orange-600 hover:underline">Forgot password?</a>
                </div>
                <div className="relative">
            ...
            <div className="border-t border-sand-200 pt-4 text-xs text-deep-navy-500">
              ...
              <Link href="/register" className="font-bold text-brand-orange-600 hover:underline">
                Create one now
              </Link>
            </div>
          </CardContent>
